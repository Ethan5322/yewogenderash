  ...
  return (
    <section className="mt-8 rounded-xl border bg-card p-6 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h2 className="font-display text-base font-semibold">Your money</h2>
        <Link
          href="/dashboard/payouts"
          className="inline-flex items-center gap-1 text-sm font-medium text-primary hover:underline"
        >
          Payouts <ArrowRight className="h-3.5 w-3.5" aria-hidden />
        </Link>
      </div>
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-3">
        <div className="rounded-lg border bg-muted/30 p-4">
          <p className="flex items-center gap-1.5 text-xs text-muted-foreground">
            <HandCoins className="h-3.5 w-3.5" aria-hidden /> Raised
          </p>
        ...
        <div className="rounded-lg border border-primary/30 bg-primary/5 p-4">
          <p className="flex items-center gap-1.5 text-xs text-muted-foreground">
            <Wallet className="h-3.5 w-3.5" aria-hidden /> Available to withdraw
          </p>
          <p className="mt-1 font-display text-lg font-bold tabular-nums text-primary">
            {formatETB(totalAvailable, currency)}
          </p>
          <p className="text-xs text-muted-foreground">after the transaction fee</p>
        </div>
        <div className="rounded-lg border bg-muted/30 p-4">
          <p className="flex items-center gap-1.5 text-xs text-muted-foreground">
            <Megaphone className="h-3.5 w-3.5" aria-hidden /> Campaigns
          </p>
            ...
            >
              <span className="min-w-0">
                ...
                <span className="text-xs text-muted-foreground">
                  {c.status} · view every transaction
                </span>
              </span>
